...
window.jQuery(function ($) {
  ...
  (function () {
    ...
    let Title = `${'cv'.toUpperCase()}-v0.3.1-b3` ;

    $(window).ready(function () {
      console.log(`%ccv v0.3.1-b3`, 'color:red;font-weight:bold;font-size:24px;');
      console.log(`%cEnv: dev, Branch: irfan-cv`, 'color:Purple;font-weight:bold;font-size:18px;');
      console.group(Title);
